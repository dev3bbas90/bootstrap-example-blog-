        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="/save update my profile" enctype="multipart/form-data">
                        <!-- action="{{ url('/register') }}" -->
                        {{ csrf_field() }}
                    ...
                    <!-- ////////////////////////////////////////////////////////// -->
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                             ...
                             <button type="reset" class="btn btn-danger" onclick="window.open('profile/{{Auth::user()->id}}','_self')">
                                      Cancel Changes
                                </button>
                            </div>
                        </div>
